...
export const FONTS = {
	fontLg: { fontSize: SIZES.fontLg, color: COLORS.text, lineHeight: 20, fontFamily: 'DMSans-Regular' },
	font: { fontSize: SIZES.font, color: COLORS.text, lineHeight: 20, fontFamily: 'DMSans-Regular' },
	fontSm: { fontSize: SIZES.fontSm, color: COLORS.text, lineHeight: 18, fontFamily: 'DMSans-Regular' },
	fontXs: { fontSize: SIZES.fontXs, color: COLORS.text, lineHeight: 14, fontFamily: 'DMSans-Regular' },
	h1: { fontSize: SIZES.h1, color: COLORS.title, fontFamily: 'DMSans-SemiBold' },
	h2: { fontSize: SIZES.h2, color: COLORS.title, fontFamily: 'DMSans-SemiBold' },
	h3: { fontSize: SIZES.h3, color: COLORS.title, fontFamily: 'DMSans-SemiBold' },
	h4: { fontSize: SIZES.h4, color: COLORS.title, fontFamily: 'DMSans-SemiBold' },
	h5: { fontSize: SIZES.h5, color: COLORS.title, fontFamily: 'DMSans-SemiBold' },
	h6: { fontSize: SIZES.h6, color: COLORS.title, fontFamily: 'DMSans-SemiBold' },
	fontBold: { fontFamily: 'DMSans-Bold' },
	fontMedium: { fontFamily: 'DMSans-Medium' },
	fontTitle: { fontFamily: 'DMSans-Medium' },
	fontRegular: { fontFamily: 'DMSans-Regular' },
	fontSemiBold: { fontFamily: 'DMSans-SemiBold' },
	fontLight: { fontFamily: 'DMSans-Light' },
	fontExtraBold: { fontFamily: 'DMSans-ExtraBold' },
	fontDMSerifDisplayItalic: { fontFamily: 'DMSans-Italic' },
}
